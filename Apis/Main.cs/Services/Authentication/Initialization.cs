...
{
    public static void RegisterAuthenticationService(this IServiceCollection services, IHostEnvironment env)
    {
        if (env.EnvironmentName == Environments.Development && Environment.GetEnvironmentVariable("SERVICE_USE_PRODUCTION_AUTH") != "1")
        {
        ...
        else
        {
            ...
            services.AddTransient<IAuthenticationService, GrpcAuthenticationService>();
        }
    }
}